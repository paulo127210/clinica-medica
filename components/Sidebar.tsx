...
import {
  ...
  FileText, DollarSign, Package, Bell, Activity
} from 'lucide-react'
    ...
    <aside className="w-64 bg-green-900 text-white flex flex-col min-h-screen shadow-xl">
      ...
      <div className="p-4 border-t border-green-800">
        <div className="flex items-center gap-3 px-4 py-2">
          <div className="w-8 h-8 rounded-full bg-green-500 flex items-center justify-center text-sm font-bold shadow">A</div>
          <div>
            <p className="text-sm font-medium text-white">Administrador</p>
            <p className="text-xs text-green-300">admin@clinica.local</p>
          </div>
        </div>
      </div>
    </aside>
